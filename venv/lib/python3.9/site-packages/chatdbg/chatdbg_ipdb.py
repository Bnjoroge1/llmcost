...
class ChatDBG(pdb.Pdb):
    ...
    def do_version(self, arg):
        print(f"ChatDBG version {importlib.metadata.metadata('ChatDBG')['Version']}")

    _ScriptTarget = pdb._ScriptTarget
    Restart = pdb.Restart
    SystemExit = pdb.SystemExit
    
    def _ModuleTarget(self, arg):
        return pdb._ModuleTarget(self, arg)
